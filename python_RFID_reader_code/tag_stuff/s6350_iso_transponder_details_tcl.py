...
import serial
import list_ports
import s6350_iso_transponder_details
from s6350_iso_transponder_details import *
import tkinter
from tkinter import *

def do_it():

    all_results = ti_iso_transponder_details(topbox.e1.get())
...
win = Frame()
win.pack()
win.master.title('Transponder Details')  # This is the main window title
#
...
topbox.b2 = Button(topbox, relief = RAISED, text='Tag Details')
...
#
# The commented out command for the button b2 is a good example of
...
#topbox.b2['command'] = lambda: ti_iso_transponder_details(e1.get())
