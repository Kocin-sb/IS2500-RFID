...
import serial
import list_ports
import s6350_iso_read_addressed_block
from s6350_iso_read_addressed_block import *
import tkinter
from tkinter import *

def do_it():

    all_results = ti_read_addressed_block(topbox.e1.get(),
                                          secondbox.e1.get(),
                                          secondbox.e2.get())
...
win = Frame()
win.pack()
win.master.title('Read Addressed Block')  # This is the main window title
#
...
topbox.b2 = Button(topbox, relief = RAISED, text='Read Tag')
...
secondbox.e1 = Entry(secondbox, width=25, relief=SUNKEN, bd=2,)
secondbox.l2 = Label(secondbox, text='Block # in hex:')
secondbox.e2 = Entry(secondbox, width=10, relief=SUNKEN, bd=2,)
